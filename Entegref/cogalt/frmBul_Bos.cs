...
namespace Entegref
{
    public partial class frmDepoTipiBul : DevExpress.XtraEditors.XtraForm
    {
        int sira = 0;
        public frmDepoTipiBul(int _sira)
        {
            InitializeComponent();
            sira = _sira;
        }
        ...
        private void frmBul_Bos_FormClosed(object sender, FormClosedEventArgs e)
        {

        }

        private void frmBul_Bos_FormClosing(object sender, FormClosingEventArgs e)
        {
